...
# This script pulls staging files from /content and /imager and copies them to this machine.
...
echo -e "\n\nChoosing (y) will retrieve new and changed files from ${BLUE}${REPO}${NC} on the ${BLUE}staging site${NC} and put them onto your machine.\nContinue? (y/n): \c"

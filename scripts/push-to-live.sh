...
rsync --archive --compress --partial --update --verbose --human-readable --exclude=".DS_Store" ../web/content "$LIVE_SERVER_SSH":/websites/"$REPO"/web
echo -e "Uploading new and changed files in /web/dist\n"
rsync --archive --compress --partial --update --verbose --human-readable --exclude=".DS_Store" ../web/dist "$LIVE_SERVER_SSH":/websites/"$REPO"/web
